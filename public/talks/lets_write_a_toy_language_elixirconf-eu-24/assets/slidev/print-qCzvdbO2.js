import{d,a9 as u,y as h,b as a,e as t,x as s,A as r,F as f,a7 as g,o as l,aa as v,l as x,g as b}from"../modules/vue-DbN8tvYr.js";import{u as y,j as N,c as _,b as k}from"../index-0YvhmMPR.js";import{N as w}from"./NoteDisplay-C3I9Tpwr.js";import"../modules/shiki-BKmJkS9J.js";const D={id:"page-root"},L={class:"m-4"},T={class:"mb-10"},V={class:"text-4xl font-bold mt-2"},B={class:"opacity-50"},H={class:"text-lg"},S={class:"font-bold flex gap-2"},j={class:"opacity-50"},A=t("div",{class:"flex-auto"},null,-1),C={key:0,class:"border-main mb-8"},F=d({__name:"print",setup(M){const{slides:m,total:p}=y();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
