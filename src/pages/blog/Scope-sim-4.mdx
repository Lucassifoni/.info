...
title: "A remote-controlled telescope with Elixir & Vue -- Part 4 : Simulating image capture and focusing"
...
**Safari/iOS users** : the below demo does not work. I will have to consider using [this polyfill](https://github.com/davidenke/context-filter-polyfill).
