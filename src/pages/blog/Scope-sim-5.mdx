...
title: "A remote-controlled telescope with Elixir & Vue -- Part 5 : Porting the depth of field simulation to Elixir + Rust"
description: "Fifth entry of my build log"
pubDate: "Jan 5 2023"
---

In [the last entry](/blog/Scope-sim-4), I finished with a plausible depth of field simulation.
...
The implementation can be found [on GitHub](https://github.com/Lucassifoni/oiseaux/blob/067c5b9047a0e309a6c4b1547d0d88fb4251f482/native/rxopticsnif/src/dof.rs#L84) but it's quite simple.
