...
- [x] Part 5 : [Porting the depth of field simulation to Elixir + Rust](/blog/Scope-sim-5)
- Part 6 : [Three.js + websockets = a 3D moving telescope](/blog/Scope-sim-6)
- Part 7 : [Elixir architecture questions](/blog/Scope-sim-7)
- Part 8 : [Controlling motors from Elixir](/blog/Scope-sim-8)
- Part 9 : [Talk — Code BEAM EU 23: Prototyping a remote-controlled telescope with Elixir](/blog/prototyping-elixir-telescope-code-beam)
