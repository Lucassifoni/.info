...
Next post will focus on a basic remote control interface and scope state visualizer. This is important to refine both the digital and physical remotes UI/UX. 