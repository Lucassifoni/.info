...
title: "Computed / reactive property flows in Elixir, not specificially for LiveView"
description: "Spreadsheet-like computed / reactive properties in Elixir with automatic dependency tracking. Framework-independent approach to computed properties."
pubDate: "May 12 2025"
...
In [a previous post](/blog/computed-properties-in-liveview), I've shown how I thought computed or reactive properties could be implemented with pure patterns, without hooking in the Liveview runtime. I want to introduce another take on that, that gives the impression of reactivity, but keeping the purity that I find manageable.
