...
[🔗 source](https://github.com/elixir-plug/plug/blob/fef28b80a0a1c9365d5608b051120419c863292d/lib/plug/conn.ex#L473)
...
[🔗 source](https://github.com/elixir-plug/plug/blob/fef28b80a0a1c9365d5608b051120419c863292d/lib/plug/conn.ex#L479)
```elixir
def send_file(
...
[🔗 source](https://github.com/elixir-plug/plug/blob/fef28b80a0a1c9365d5608b051120419c863292d/lib/plug/conn.ex#L487)
```elixir
if file =~ "\0" do
...
[🔗 source](https://github.com/elixir-plug/plug/blob/fef28b80a0a1c9365d5608b051120419c863292d/lib/plug/conn.ex#L491)
```elixir
 conn =
...
[🔗 source](https://github.com/elixir-plug/plug/blob/fef28b80a0a1c9365d5608b051120419c863292d/lib/plug/conn.ex#L1835)
```elixir
...
[🔗 source](https://github.com/elixir-plug/plug/blob/fef28b80a0a1c9365d5608b051120419c863292d/lib/plug/conn.ex#L494)
```elixir
{:ok, body, payload} =
...
[🔗 source](https://github.com/elixir-plug/plug/blob/fef28b80a0a1c9365d5608b051120419c863292d/lib/plug/conn/adapter.ex#L73)
...
[🔗 source](https://github.com/elixir-plug/plug_cowboy/blob/3960916cf06b94934d77f144a94dc1edc7a7801c/lib/plug/cowboy/conn.ex#L40)
```elixir
@impl true
...
[🔗 source](https://github.com/ninenines/cowboy/blob/22adc4de517bf54661795f6e18b6b2e62aec4140/src/cowboy_req.erl#L793)
```erlang
...
[🔗 source](https://github.com/ninenines/cowboy/blob/22adc4de517bf54661795f6e18b6b2e62aec4140/src/cowboy_req.erl#L832)
```erlang
...
[🔗 source](https://github.com/ninenines/cowboy/blob/22adc4de517bf54661795f6e18b6b2e62aec4140/src/cowboy_req.erl#L921)
```erlang
%% Stream handlers.
...
[🔗 source](https://github.com/ninenines/cowboy/blob/22adc4de517bf54661795f6e18b6b2e62aec4140/src/cowboy_http.erl#L255)
```erlang
%% ...
...
[🔗 source](https://github.com/ninenines/cowboy/blob/22adc4de517bf54661795f6e18b6b2e62aec4140/src/cowboy_http.erl#L934)
```erlang
...
[🔗 source](https://github.com/ninenines/cowboy/blob/22adc4de517bf54661795f6e18b6b2e62aec4140/src/cowboy_http.erl#L1028)
```erlang
...
[🔗 source](https://github.com/ninenines/cowboy/blob/22adc4de517bf54661795f6e18b6b2e62aec4140/src/cowboy_http.erl#L1084)
```erlang
...
[🔗 source](https://github.com/ninenines/cowboy/blob/22adc4de517bf54661795f6e18b6b2e62aec4140/src/cowboy_http.erl#L1237)
```erlang
...
Let's then follow to erlang's `file` module, where we find two function heads :
...
[🔗 source](https://github.com/erlang/otp/blob/928b323d91386e56d94eb8a6b556dc475a949798/lib/kernel/src/file.erl#L1332)
```erlang
...
[🔗 source](https://github.com/erlang/otp/blob/928b323d91386e56d94eb8a6b556dc475a949798/lib/kernel/src/socket.erl#L3064)
```erlang
...
[🔗 source](https://github.com/erlang/otp/blob/928b323d91386e56d94eb8a6b556dc475a949798/erts/preloaded/src/prim_socket.erl#L691)
```erlang
...
[🔗 source](https://github.com/erlang/otp/blob/928b323d91386e56d94eb8a6b556dc475a949798/erts/emulator/nifs/common/prim_socket_nif.c#L5841)
```c
/* ----------------------------------------------------------------------
 * nif_sendfile/1,4,5
 *
...
[🔗 source](https://github.com/erlang/otp/blob/928b323d91386e56d94eb8a6b556dc475a949798/erts/emulator/nifs/common/prim_socket_nif.c#L5939)
```c
...
[🔗 source](https://github.com/erlang/otp/blob/928b323d91386e56d94eb8a6b556dc475a949798/erts/emulator/nifs/common/prim_socket_nif.c#L2581)
```c
...
[🔗 source](https://github.com/erlang/otp/blob/928b323d91386e56d94eb8a6b556dc475a949798/erts/emulator/nifs/unix/unix_socket_syncio.c#L2286)
```c
/* ========================================================================
...
[🔗 source](https://github.com/erlang/otp/blob/928b323d91386e56d94eb8a6b556dc475a949798/erts/emulator/nifs/unix/unix_socket_syncio.c#L6103)
```c
...
[🔗 source](https://github.com/erlang/otp/blob/928b323d91386e56d94eb8a6b556dc475a949798/erts/emulator/nifs/unix/unix_socket_syncio.c#L6144)
```c
