...
<div class="message">
⚠️ After building this, I've learnt that all of that batching and distribution work is native to Nx.Serving. Well, that's another case of being in an ecosystem that does tremenous work for you ;-) . Thanks to the Nx team.
</div>
