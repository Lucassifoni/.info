...
title: "Hosting a small language (Ovo2) from scratch in Elixir, pt 2 <br/>"
description: ""
pubDate: "May 23 2023"
...
So next time, I will update the tokenizer to discriminate more syntax.
...
I'm not sure that I like `tail` leaking from no visible spot though.