...
title: "Un petit langage (Ovo2) dans Elixir, pt 8<br/>Fin : le Ovo Optimal Personal System (oops), avec liveview"
...
- Partie 7 : [fonctionnalités bizarres et état global](/fr/blog/small-lang-elixir-7)
- [x] Partie 8 : [un environment graphique avec liveview](/fr/blog/small-lang-elixir-8)
...
- `rbonk` : bonks a value on a foreign runner
...
Since `rbonk` has been introduced, you can use values pushed to the stack of a runner, from within another runner (or program).
...
run = \n, out ->
    ...
    if equals(n, 0) then
        ...
        run(subtract(100, rbonk(`EWTiZxncF`)), nout) # pop a value from the register
    end
end
